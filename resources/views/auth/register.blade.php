...
<div class="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8">
        ...
        <form class="mt-8 space-y-6" method="POST" action="{{ route('register') }}" aria-label="Registration form">
            @csrf
            <div class="rounded-md shadow-sm space-y-4">
                <!-- Name Input - Improved with visible label -->
                <div>
                ...
                <!-- Email Input - Consistent styling with login -->
                <div>
                ...
                <!-- Role Select - Improved styling and accessibility -->
                <div>
                    ...
                    @error('role')
                        <p id="role-error" class="mt-2 text-sm text-red-600" role="alert">{{ $message }}</p>
                    @enderror
                </div>

                <!-- Password Input - Added strength meter and visibility toggle -->
                <div>
                    ...
                    <div id="password-strength" class="h-1 mt-1 bg-gray-200 rounded overflow-hidden">
                        <div id="password-strength-bar" class="h-full transition-all duration-300 ease-out"></div>
                    </div>
                ...
                <!-- Confirm Password - Added matching indicator -->
                <div>
                    ...
                    @error('password_confirmation')
                        <p id="password-confirm-error" class="mt-2 text-sm text-red-600" role="alert">{{ $message }}</p>
                    @enderror
                </div>
            </div>

            <!-- Terms and Conditions - Added for legal compliance -->
            <div class="flex items-start">
                ...
                <div class="ml-3 text-sm">
                    ...
                    @error('terms')
                        <p id="terms-error" class="mt-1 text-sm text-red-600" role="alert">{{ $message }}</p>
                    @enderror
                </div>
            </div>
            ...
            <div>
                <button type="submit" id="register-button"
                    ...
                    onclick="this.disabled=true;this.innerHTML='<svg class=\'animate-spin -ml-1 mr-2 h-4 w-4 text-white\' xmlns=\'http://www.w3.org/2000/svg\' fill=\'none\' viewBox=\'0 0 24 24\'><circle class=\'opacity-25\' cx=\'12\' cy=\'12\' r=\'10\' stroke=\'currentColor\' stroke-width=\'4\'></circle><path class=\'opacity-75\' fill=\'currentColor\' d=\'M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z\'></path></svg> Creating account...';this.form.submit();">
                    Register
                </button>
            </div>
        </form>

        <!-- Social Login Options - Consistent with login -->
        <div class="mt-6">
            <div class="relative">
        ...
        <!-- Login Link - Consistent with login page -->
        <div class="mt-8 text-center">
            <p class="text-sm text-gray-600">
                Already have an account? 
                <a href="{{ route('login') }}" class="font-medium text-indigo-700 hover:text-indigo-600">
                    Sign in
                </a>
            </p>
        </div>
