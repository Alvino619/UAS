            ...
            <div class="px-4 py-5 sm:p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        ...
                        <dd class="flex items-baseline">
                            <div class="text-2xl font-semibold text-gray-900">{{ $courses->where('status', 'published')->count() }}</div>
                        </dd>
                    </div>
                </div>
            </div>
            ...
            <div class="px-4 py-5 sm:p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        ...
                        <dd class="flex items-baseline">
                            <div class="text-2xl font-semibold text-gray-900">{{ $courses->where('status', 'pending')->count() }}</div>
                        </dd>
                    </div>
                </div>
            </div>
        ...
        <div class="px-4 py-5 sm:px-6 border-b border-gray-200">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-500">All courses you've created.</p>
                </div>
                            ...
                            @foreach($courses as $course)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        ...
                                        <a href="{{ route('courses.manage.edit', $course) }}" class="text-indigo-600 hover:text-indigo-900">Edit</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
