...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <div class="px-4 py-5 sm:p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        ...
                        <dd class="flex items-baseline">
                            <div class="text-2xl font-semibold text-gray-900">{{ $stats['total_courses'] }}</div>
                        </dd>
                    </div>
                </div>
            </div>
            ...
            <div class="px-4 py-5 sm:p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        ...
                        <dd class="flex items-baseline">
                            <div class="text-2xl font-semibold text-gray-900">{{ $stats['pending_courses'] }}</div>
                        </dd>
                    </div>
                </div>
            </div>
            ...
            <div class="px-4 py-5 sm:p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        ...
                        <dd class="flex items-baseline">
                            <div class="text-2xl font-semibold text-gray-900">{{ $stats['published_courses'] }}</div>
                        </dd>
                    </div>
                </div>
            </div>
    ...
    <div class="bg-white shadow overflow-hidden sm:rounded-lg mb-8">
        <div class="px-4 py-5 sm:px-6 border-b border-gray-200">
            <h3 class="text-lg leading-6 font-medium text-gray-900">Pending Course Approvals</h3>
            <p class="mt-1 text-sm text-gray-500">Courses waiting for your approval.</p>
        </div>
        <div class="bg-white overflow-hidden">
            @if($pendingCourses->isEmpty())
                <div class="text-center py-12">
                    ...
                    <h3 class="mt-2 text-lg font-medium text-gray-900">No pending courses</h3>
